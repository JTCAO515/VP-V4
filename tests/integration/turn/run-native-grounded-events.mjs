...
try{
 ...
 const profile={VP_NATIVE_GROUNDED_TEST:'1',VP_NATIVE_TEXT_TEST:'1',VP_NATIVE_TEXT_API_URL:e.api,VP_NATIVE_TEXT_CONTROL_URL:e.controlURL,VP_NATIVE_TEXT_EMAIL:e.users[0].email,VP_NATIVE_TEXT_UI_EN_EMAIL:e.users[2].email,VP_NATIVE_TEXT_UI_ZH_EMAIL:e.users[3].email};
