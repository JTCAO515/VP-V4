...
const selectedTest=process.env.VP_OPS_TEST_FILE||'tests/integration/ops/local-review.test.mjs';
if(!/^tests\/integration\/(ops|knowledge)\/[a-z0-9-]+\.test\.mjs$/.test(selectedTest))throw new Error('Invalid disposable test selection');
