...
Implemented on the source following PR347, in an isolated worktree. Real usage-only Staging recovery is recorded in ../staging-usage-live-20260913/verification.md; full#195/#196/S2 remains pending. No remote ledger, account, price, scope, migration or production change has been made by this slice.
...
UNRUN: real supplier outage/tail loss, supplier invoice reconciliation, automatic lost-answer recovery, complete cancellation/Trip recovery and release acceptance. Historical no-usage holds are not retrospectively settled by this implementation. Existing physical-device deferral remains in force.
