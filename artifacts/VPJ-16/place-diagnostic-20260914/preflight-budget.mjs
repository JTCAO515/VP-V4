...
const root='/Users/jtcao/Library/Caches/visepanda/place-diagnostic-20260914';
...
writeFileSync(root+'/budget-preflight.json',JSON.stringify({at:new Date().toISOString(),status:'PASS',scope:'next admission plus headroom only; sequential full plan may stop at unchanged database cap',fullPlanWorstCaseFunded:false,plannedCallsPerOwner:1,rows:result},null,2)+'\n',{mode:0o600});
