...
The tracker plan is published as V4-01 through V4-31 while preserving R0-R5. It adds ContextPlan, Tool Policy Gateway, ConstraintEngine and a rejectable RoutePattern RAG spike. LangChain/LangGraph/GraphRAG/multi-agent are not default implementation work. Current ready frontier is #49, #84 and #87; #15 remains blocked by #84, and every other V4 Issue remains blocked until its declared dependencies close.
