...
- Current frontier: #122 AI-51b supersedes the closed/unmerged Magic Link fix and implements operator-provisioned email/password login, sign-out and five-language UI. Preview password sign-in/sign-out UI, anonymous 401 and retired-route 404 are evidenced; authenticated Trip 403 and owner/other-user evidence remain open. #122 blocks #84; #84 continues to block #15. #87 V4-01 is closed.
