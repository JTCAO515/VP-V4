...
2026-09-17 用户授权将竞品研究转为[产品体验增量](program/2026-09-05/PRODUCT-EXPERIENCE-2026-09-17.md)：优先交付可修改的小成果、每种Ask结果的具体下一步、同Trip多视图与局部修改影响；住宿/交通/材料继续接回同一确认版本，分享保持本地隐私预览。具体17条验收归入14个现有开放任务，保持阶段、依赖、已完成证据和酒店L1a/L1b范围，不新增OTA交易、B2B产品或公开托管。
