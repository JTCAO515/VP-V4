...
| #87 V4-01 | Program / Architecture | docs/architecture/**, docs/contracts/**, docs/agents/issue-execution-contract.md | pnpm check; pnpm docs:check | artifacts/V4-01/commands.jsonl、artifacts/V4-01/unrun.md、parity registry, framework adoption matrix, execution-contract rows | — |
