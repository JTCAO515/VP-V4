...
| #120 AI-51a | Identity / Auth PKCE | `app/(auth)/**, app/api/auth/**, lib/server/identity/**, tests/{contract,security,e2e}/identity/**, docs/contracts/user-data-adapter.md, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md, artifacts/AI-51a/unrun.md` | `pnpm test:contract`; `pnpm test:security`; `pnpm test:e2e`; `pnpm docs:check`; `pnpm check`; browser QA; `jq empty docs/handoff.json`; `git diff --check` | `artifacts/AI-51a/commands.jsonl`, `artifacts/AI-51a/unrun.md`, callback/session evidence summary | RL-01 RL-02 RL-07 |
