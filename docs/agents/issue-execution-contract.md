...
| #15 AI-13 | Trip Canvas UI | `components/canvas/**, app/visepanda/trips/**, lib/i18n.ts, tests/e2e/canvas/ai-13-proposal-loop.test.mjs, tests/e2e/canvas/v4-10-trip-canvas.test.mjs, tests/e2e/canvas/v4-11-place-view.test.mjs, tests/e2e/canvas/v4-12-trip-actions.test.mjs, tests/e2e/memory/v4-15-memory-receipts.test.mjs, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md, artifacts/AI-13/**, docs/superpowers/plans/2026-08-28-ai-13-trip-canvas-proposal-loop.md` | `pnpm check`; `pnpm test:e2e`; `pnpm docs:check`; `jq empty docs/handoff.json`; `git diff --check`; browser QA at 1280x800 and 390x844, `lang=ar dir=rtl` pass | `artifacts/AI-13/commands.jsonl`, `artifacts/AI-13/unrun.md`, browser + 390x844 + RTL screenshots | RL-01 |
...
| #17 AI-15 | Release gate R1 | `docs/acceptance/r1-*.md, artifacts/AI-15/**, docs/{handoff.json,agents/issue-execution-contract.md}, HANDOFF.md, CONTEXT.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:security`; `pnpm test:integration`; `pnpm test:e2e`; `pnpm evals`; `pnpm db:verify`; `pnpm check:flags`; `pnpm docs:check`; `git diff --check` | `artifacts/AI-15/commands.jsonl`, `artifacts/AI-15/unrun.md`, eight-dimension acceptance report | RL-01 RL-02 RL-03 |
...
| #20 AI-18 | Knowledge / Retrieval | `lib/server/knowledge/retrieval/lexical/**, evals/qrels/**, docs/contracts/lexical-retrieval-baseline.md, docs/agents/issue-execution-contract.md, artifacts/AI-18/**, docs/handoff.json, HANDOFF.md, CONTEXT.md, docs/superpowers/plans/2026-08-28-ai-18-lexical-retrieval.md` | `pnpm check`; `pnpm evals`; `pnpm docs:check`; `jq empty docs/handoff.json`; `git diff --check` | per-locale MRR/nDCG/no-answer report, command ledger, unrun disclosure | — |
| #21 AI-19 | Knowledge / Retrieval | `lib/server/knowledge/retrieval/**, tests/{contract,security}/knowledge/**, evals/qrels/**, docs/contracts/hybrid-retrieval-baseline.md, docs/superpowers/plans/2026-08-28-ai-19-hybrid-retrieval.md, artifacts/AI-19/**, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md, supabase/migrations/**` | `pnpm check`; `pnpm evals`; `pnpm db:verify`, `pnpm test:integration`; `pnpm test:security`; `pnpm docs:check`; `git diff --check` | `artifacts/AI-19/commands.jsonl`, `artifacts/AI-19/unrun.md`, `artifacts/AI-19/acceptance.md`, recall/rank report, leakage suite | RL-02 RL-05 |
| #22 AI-20 | Knowledge / Claims | `lib/server/knowledge/claim/**, components/chat/cards/**, lib/i18n.ts, tests/{contract,security}/knowledge/**, evals/claims/**, docs/contracts/grounded-execution-baseline.md, docs/superpowers/plans/2026-08-28-ai-20-grounded-execution.md, artifacts/AI-20/**, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:security`; `pnpm evals`; `pnpm docs:check`; `git diff --check` | `artifacts/AI-20/commands.jsonl`, `artifacts/AI-20/unrun.md`, typed claim fixtures, deterministic card renders | RL-04 RL-05 |
| #23 AI-21 | Release gate R2 | `docs/acceptance/r2-*.md, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md, artifacts/AI-21/**, docs/superpowers/plans/2026-08-28-ai-21-r2-acceptance.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:security`; `pnpm evals`; `pnpm docs:check`; `pnpm db:verify`; `git diff --check` | `artifacts/AI-21/commands.jsonl`, `artifacts/AI-21/unrun.md`, eight-dimension acceptance report | RL-04 RL-05 |
| #24 AI-22 | Policy / Licence | `lib/server/policy/**, tests/{contract,security}/policy/**, docs/contracts/policy-receipts.md, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md, artifacts/AI-22/**, docs/superpowers/plans/2026-08-28-ai-22-policy-receipts.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:security`; `pnpm docs:check`; `pnpm db:verify`; `git diff --check` | `artifacts/AI-22/commands.jsonl`, `artifacts/AI-22/unrun.md`, PolicyReceipt fixtures, cascade proof | RL-06 |
| #25 AI-23 | Knowledge / Migration | `lib/server/knowledge/import/**, tests/security/knowledge/import-migration-security.test.ts, docs/contracts/import-migration-ledger.md, docs/superpowers/plans/2026-08-28-ai-23-import-migration.md, artifacts/AI-23/**, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md` | `pnpm check`; `pnpm test:security`; `pnpm db:verify`; `pnpm docs:check`; `git diff --check` | `artifacts/AI-23/commands.jsonl`, `artifacts/AI-23/unrun.md`, import/review golden fixtures, RLS-gap evidence | RL-08 |
| #26 AI-24 | Knowledge / Import | `lib/server/knowledge/import/**, tests/security/knowledge/candidate-import-security.test.ts, docs/contracts/candidate-import-dry-run.md, docs/superpowers/plans/2026-08-28-ai-24-candidate-import.md, artifacts/AI-24/**, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:security`; `pnpm evals`; `pnpm db:verify`; `pnpm test:integration`; `pnpm docs:check`; `git diff --check` | `artifacts/AI-24/commands.jsonl`, `artifacts/AI-24/unrun.md`, dry-run diff, idempotency/conflict log | RL-08 |
| #27 AI-25 | Ops deployment | `lib/server/knowledge/review/**, tests/security/knowledge/ops-review-security.test.ts, docs/contracts/ops-review-ledger.md, docs/superpowers/plans/2026-08-28-ai-25-ops-review.md, artifacts/AI-25/**, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:security`; `pnpm test:e2e`; `pnpm evals`; `pnpm docs:check`; `git diff --check` | `artifacts/AI-25/commands.jsonl`, `artifacts/AI-25/unrun.md`, unavailable-deploy evidence, author/reviewer and audit rollback fixtures | RL-08 |
| #28 AI-26 | Jobs / Queue | `lib/server/jobs/**, tests/{integration,security}/jobs/**, docs/contracts/projection-queue-c0.md, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md, artifacts/AI-26/**, docs/superpowers/plans/2026-08-28-ai-26-projection-worker.md`; no `supabase/functions/**` until a separately accepted worker deployment Issue | `pnpm check`; `pnpm test:integration`; `pnpm test:security` | `artifacts/AI-26/commands.jsonl`, `artifacts/AI-26/unrun.md`, crash/duplicate/poison/replay fixture log | RL-02 |
...
| #37 AI-35 | ExternalEvidenceResolver | `lib/server/external-evidence/**, tests/{contract,security}/external-evidence/**, docs/contracts/external-evidence-c0.md, artifacts/AI-35/**, docs/agents/issue-execution-contract.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:security` | policy receipts, freshness ladder | RL-06 |
| #38 AI-36 | External / Weather | `lib/server/external-evidence/weather/**, components/chat/cards/**, tests/{contract,e2e}/external-evidence/weather/**, docs/contracts/weather-c0.md, artifacts/AI-36/**, docs/agents/issue-execution-contract.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:e2e` | card fixtures, degraded paths | RL-04 RL-06 |
| #39 AI-37 | User artifacts | `lib/server/artifacts/**, lib/server/trip/**, tests/{contract,security,integration}/artifacts/**, docs/contracts/user-artifact-c0.md, artifacts/AI-37/**, docs/agents/issue-execution-contract.md` | `pnpm check`; `pnpm test:security`; `pnpm test:integration` | redaction proof, import idempotency | RL-06 RL-07 |
| #40 AI-38 | External / Rail | `lib/server/external-evidence/rail/**, lib/server/artifacts/user-artifact.ts (owner-bound confirmed-artifact read projection only), docs/runbooks/**, tests/{contract,security}/external-evidence/rail/**, docs/contracts/rail-guidance-c0.md, artifacts/AI-38/**, docs/agents/issue-execution-contract.md` | `pnpm check`; `pnpm test:contract`; `pnpm test:security` | zero-crawler network log | RL-06 |
...
| #51 AI-47 | ModelGateway / Governance | `lib/server/model-gateway/prompt/**, lib/server/model-gateway/registry/**, tests/contract/model-gateway/version-registry.test.ts, docs/contracts/model-version-registry.md, artifacts/AI-47/**, docs/agents/issue-execution-contract.md` | `pnpm check`; `pnpm test:contract`; `pnpm evals`; `pnpm docs:check` | version registry snapshot, drift trigger log, unrun disclosure | RL-07 |
| #52 AI-48 | Security / Cost | `lib/server/model-gateway/budget/**, lib/server/identity/quota/**, tests/security/cost/**, docs/contracts/cost-guard-c0.md, artifacts/AI-48/**, docs/agents/issue-execution-contract.md` | `pnpm check`; `pnpm test:security`; `pnpm test:integration`; `pnpm docs:check` | quota-exhaustion trace, synthetic abuse report, unrun disclosure | RL-07 |
...
| #54 AI-50 | KnowledgeSystem / Ops | `lib/server/knowledge/report/**, apps/ops/report/**, tests/security/takedown/**, docs/contracts/report-ledger-c0.md, artifacts/AI-50/**, docs/agents/issue-execution-contract.md` | `pnpm check`; `pnpm test:security`; `pnpm test:integration`; `pnpm test:e2e`; `pnpm docs:check` | cascade-invalidation proof, audit record samples, unrun disclosure | RL-02 RL-08 RL-09 |
...
| #90 V4-05 | Knowledge / Planning Research | `docs/benchmarks/route-pattern/**, evals/route-pattern/**, artifacts/V4-05/**, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md` | `pnpm check`; `pnpm evals`; `pnpm docs:check`; `jq empty docs/handoff.json`; `git diff --check` | `artifacts/V4-05/commands.jsonl`, `artifacts/V4-05/unrun.md`, rights matrix, paired retrieval report, adopt/reject record | RL-02 RL-05 RL-06 |
...
| #139 WEB-05 | Frontend design direction | `docs/design/frontend-redesign/**, docs/frontend-redesign-issue-plan.md, docs/agents/issue-execution-contract.md, docs/handoff.json, HANDOFF.md, CONTEXT.md, artifacts/WEB-05/**` | `pnpm docs:check`; local Markdown-link check; `git diff --check` | `artifacts/WEB-05/commands.jsonl`, `artifacts/WEB-05/unrun.md`, three directions, selection/dissent record | — |
