...
当前品牌/任务计量/基础偏好按[ADR-0025](../../adr/ADR-0025-brand-service-task-and-response-semantics.md)及其契约执行；本手册提供运营检查结构。实际状态和已有有效授权从对应Issue/PR、operator-actions读取，历史条目不扩展新操作范围。
