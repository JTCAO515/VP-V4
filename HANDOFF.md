...
- V4-14/#99, V4-16/#101, V4-18/#103 and V4-22/#107 through V4-30/#115 are merged as five-locale/RTL, frontend-only unavailable boundaries. They withhold unsupported memory/profile/today/tool/import/offline capabilities; no route invents data, writes a Trip, invokes a provider, caches user data, accepts an artifact or treats a flag as authorization. Each has a static route contract and an unrun-runtime record.
