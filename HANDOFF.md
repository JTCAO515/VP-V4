...
- V4-14/#99, V4-16/#101, V4-18/#103, V4-22/#107 and V4-23/#108 are merged as five-locale/RTL, frontend-only unavailable boundaries. They respectively withhold unsupported Memory governance, Profile/preferences, Today state, Tool health and high-risk Safe Phrase text/TTS; no route invents data, writes a Trip, invokes an unapproved provider or treats a flag as authorization. Each has a static route contract and unrun-runtime record. The next user-facing frontend scope is the next independently safe, uncompleted V4 route; GitHub label synchronization remains skipped because `gh` has no authenticated user.
