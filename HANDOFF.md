...
- 生产版本记录不一致：不得再以“生产冻结在db5fb7b”作为当前事实，也不得据GitHub Deployment记录或路由观察声明某能力已在生产可用；在T1核实实际alias/提交前，任何生产相关结论保持未知。已授权的next安全补丁发布仍需先批准执行方案。
...
- 生产实际版本UNRUN（未核实）：此前记录为2026-09-12后线上alias保留db5fb7b；GitHub Deployments最近Production记录为2026-09-16的f14ee46与033a3f5（均success，均不在main历史，f14ee46来自base为testing-chat-vpv4的PR #419）；协调会话2026-09-23观察到生产提供2026-09-17才进入main的/research与/api/intake。三者不一致，不推断实际提交；T1只读核实后再记录。
...
- 2026-09-23 GitHub只读核对（node scripts/program-status.mjs 与 gh api）：main a90ce61，开放PR #478/#511/#514，#479于2026-09-22T00:37Z合并；76张VPJ任务61 OPEN/15 CLOSED，#503–#508 OPEN；GitHub最近Production Deployment记录为f14ee46（PR #419、base testing-chat-vpv4，不在main历史）。未连接Staging/生产、未执行付费provider。表见CURRENT-STATUS-2026-09-23.md。其余109条完整历史验证及当时FAIL/UNRUN保留在固定commit ce46abd 的 docs/handoff.json；以下为按原版本摘录。
