...
export const tripCanvasCopy: Readonly<Record<Locale, Readonly<{
  home: string; back: string; language: string; title: string; signInBody: string; signIn: string; loading: string; unavailable: string;
  eyebrow: string; lede: string; currentVersion: string; updated: string; rollbackNotice: string; proposalRefreshed: string; proposalConflict: string;
  pendingEyebrow: string; pendingTitle: string; pendingBody: string; before: string; after: string; evidenceMissing: string; assumptionsMissing: string; proposalBase: string; expires: string;
  confirming: string; confirm: string; rejecting: string; reject: string; reviseLabel: string; revising: string; revise: string; noPendingTitle: string; noPendingBody: string;
  restoreReady: string; restoreBody: string; confirmRestore: string; keepCurrent: string; historyEyebrow: string; confirmedChanges: string; noChanges: string; initialVersion: string; version: string; confirmed: string; initialBody: string; confirmedBody: string; recorded: string; inspectOrigin: string; proposalId: string; memoryProvenance: string; hardConstraint: string; preference: string; memorySource: string; receipt: string; preparing: string; restore: string; integrityEyebrow: string; integrityTitle: string; integrityBody: string;
}>>> = {
  zh: { home: "VisePanda 首页", back: "返回 VisePanda", language: "界面语言", title: "Trip Canvas", signInBody: "登录后查看此行程的当前版本。", signIn: "登录", loading: "正在读取当前版本…", unavailable: "此行程暂不可用。", eyebrow: "Trip Canvas · 权威时间线", lede: "这里显示当前行程和已确认的版本历史。每项已记录的变化都有不可变提案来源，并保持追加式历史。", currentVersion: "当前版本", updated: "更新于", rollbackNotice: "回滚不是重写。恢复会先生成新提案；只有明确确认后才会创建下一个版本。", proposalRefreshed: "已重新读取最新的权威行程状态。", proposalConflict: "此提案已变化或无法确认；请检查最新状态。", pendingEyebrow: "待确认变化", pendingTitle: "提案差异", pendingBody: "请先检查旧值和新值。确认前不会写入行程。", before: "当前值", after: "建议的新值", evidenceMissing: "证据：未记录", assumptionsMissing: "假设：未记录", proposalBase: "基于版本", expires: "到期", confirming: "正在确认…", confirm: "确认变化", rejecting: "正在拒绝…", reject: "拒绝提案", reviseLabel: "修改建议的新标题", revising: "正在创建修订…", revise: "创建修订", noPendingTitle: "没有待确认的提案", noPendingBody: "新变化必须先通过一个可见提案进入这里。", restoreReady: "已准备恢复到版本", restoreBody: "这会从已记录快照创建新版本，不会改变已有事件或版本。", confirmRestore: "确认恢复", keepCurrent: "保留当前版本", historyEyebrow: "版本历史", confirmedChanges: "已确认的变化", noChanges: "此行程尚未记录已确认变化。", initialVersion: "初始版本", version: "版本", confirmed: "已确认", initialBody: "此行程的不可变基线。", confirmedBody: "通过不可变提案应用。", recorded: "记录于", inspectOrigin: "查看来源提案", proposalId: "提案 ID：", memoryProvenance: "记忆来源", hardConstraint: "硬约束", preference: "偏好", memorySource: "记忆来源", receipt: "回执", preparing: "正在准备…", restore: "恢复为", integrityEyebrow: "完整性", integrityTitle: "唯一当前头版本", integrityBody: "时间线与当前版本读取同一份 owner-scoped 行程来源。没有 fixture 回退，也没有直接写入动作。" },
  en: { home: "VisePanda home", back: "Back to VisePanda", language: "Interface language", title: "Trip Canvas", signInBody: "Sign in to read this Trip’s current version.", signIn: "Sign in", loading: "Loading the current version…", unavailable: "This Trip is unavailable.", eyebrow: "Trip Canvas · canonical timeline", lede: "This view shows the current Trip and its confirmed version history. Each recorded change has an immutable Proposal origin and remains append-only.", currentVersion: "Current version", updated: "Updated", rollbackNotice: "Rollback is not a rewrite. Restoring first makes a new Proposal; only explicit confirmation can create the next version.", proposalRefreshed: "The latest authoritative Trip state has been re-read.", proposalConflict: "This Proposal changed or cannot be confirmed. Review the latest state.", pendingEyebrow: "Pending change", pendingTitle: "Proposal diff", pendingBody: "Review the old and new values first. The Trip is not written before confirmation.", before: "Current value", after: "Proposed new value", evidenceMissing: "Evidence: not recorded", assumptionsMissing: "Assumptions: not recorded", proposalBase: "Based on version", expires: "Expires", confirming: "Confirming…", confirm: "Confirm change", rejecting: "Rejecting…", reject: "Reject Proposal", reviseLabel: "Revise the proposed title", revising: "Creating revision…", revise: "Create revision", noPendingTitle: "No pending Proposal", noPendingBody: "Every new change must first arrive here as a visible Proposal.", restoreReady: "Restore to version ready", restoreBody: "This creates a new version from the recorded snapshot and changes no existing event or version.", confirmRestore: "Confirm restore", keepCurrent: "Keep current version", historyEyebrow: "Version history", confirmedChanges: "Confirmed changes", noChanges: "No confirmed changes have been recorded for this Trip yet.", initialVersion: "Initial version", version: "Version", confirmed: "confirmed", initialBody: "The immutable baseline for this Trip.", confirmedBody: "Applied through an immutable Proposal.", recorded: "Recorded", inspectOrigin: "Inspect origin Proposal", proposalId: "Proposal ID:", memoryProvenance: "Memory provenance", hardConstraint: "Hard constraint", preference: "Preference", memorySource: "Memory source", receipt: "receipt", preparing: "Preparing…", restore: "Restore as", integrityEyebrow: "Integrity", integrityTitle: "One current head", integrityBody: "The timeline and current version read the same owner-scoped Trip source. There is no fixture fallback and no direct write action." },
  es: { home: "Inicio de VisePanda", back: "Volver a VisePanda", language: "Idioma de la interfaz", title: "Trip Canvas", signInBody: "Inicia sesión para leer la versión actual de este viaje.", signIn: "Iniciar sesión", loading: "Cargando la versión actual…", unavailable: "Este viaje no está disponible.", eyebrow: "Trip Canvas · línea de tiempo canónica", lede: "Esta vista muestra el viaje actual y su historial de versiones confirmadas. Cada cambio registrado tiene un origen de Propuesta inmutable y se conserva de forma acumulativa.", currentVersion: "Versión actual", updated: "Actualizado", rollbackNotice: "La reversión no reescribe. Restaurar primero crea una Propuesta nueva; solo una confirmación explícita puede crear la siguiente versión.", proposalRefreshed: "Se volvió a leer el estado autoritativo más reciente del viaje.", proposalConflict: "Esta Propuesta cambió o ya no puede confirmarse. Revisa el estado más reciente.", pendingEyebrow: "Cambio pendiente", pendingTitle: "Diferencia de Propuesta", pendingBody: "Revisa primero los valores anterior y nuevo. El viaje no se escribe antes de confirmar.", before: "Valor actual", after: "Nuevo valor propuesto", evidenceMissing: "Evidencia: no registrada", assumptionsMissing: "Suposiciones: no registradas", proposalBase: "Basada en la versión", expires: "Vence", confirming: "Confirmando…", confirm: "Confirmar cambio", rejecting: "Rechazando…", reject: "Rechazar Propuesta", reviseLabel: "Revisar el título propuesto", revising: "Creando revisión…", revise: "Crear revisión", noPendingTitle: "No hay Propuesta pendiente", noPendingBody: "Todo cambio nuevo debe llegar primero como una Propuesta visible.", restoreReady: "Restauración a la versión lista", restoreBody: "Esto crea una versión nueva desde la instantánea registrada y no cambia ningún evento o versión existente.", confirmRestore: "Confirmar restauración", keepCurrent: "Mantener versión actual", historyEyebrow: "Historial de versiones", confirmedChanges: "Cambios confirmados", noChanges: "Aún no se han registrado cambios confirmados para este viaje.", initialVersion: "Versión inicial", version: "Versión", confirmed: "confirmada", initialBody: "La base inmutable de este viaje.", confirmedBody: "Aplicada mediante una Propuesta inmutable.", recorded: "Registrado", inspectOrigin: "Inspeccionar Propuesta de origen", proposalId: "ID de Propuesta:", memoryProvenance: "Procedencia de memoria", hardConstraint: "Restricción estricta", preference: "Preferencia", memorySource: "Fuente de memoria", receipt: "recibo", preparing: "Preparando…", restore: "Restaurar como", integrityEyebrow: "Integridad", integrityTitle: "Una única versión actual", integrityBody: "La línea de tiempo y la versión actual leen la misma fuente de viaje con alcance de propietario. No hay datos de prueba de respaldo ni acción de escritura directa." },
  ru: { home: "Главная VisePanda", back: "Назад к VisePanda", language: "Язык интерфейса", title: "Trip Canvas", signInBody: "Войдите, чтобы увидеть текущую версию этой поездки.", signIn: "Войти", loading: "Загружается текущая версия…", unavailable: "Эта поездка недоступна.", eyebrow: "Trip Canvas · каноническая временная шкала", lede: "Здесь показаны текущая поездка и история подтверждённых версий. У каждого записанного изменения есть неизменяемое происхождение Proposal, а история только дополняется.", currentVersion: "Текущая версия", updated: "Обновлено", rollbackNotice: "Откат не переписывает историю. Восстановление сначала создаёт новый Proposal; следующую версию создаёт только явное подтверждение.", proposalRefreshed: "Последнее авторитетное состояние поездки перечитано.", proposalConflict: "Этот Proposal изменился или больше не подтверждается. Проверьте актуальное состояние.", pendingEyebrow: "Ожидающее изменение", pendingTitle: "Разница Proposal", pendingBody: "Сначала проверьте старое и новое значения. До подтверждения поездка не записывается.", before: "Текущее значение", after: "Предложенное новое значение", evidenceMissing: "Доказательства: не записаны", assumptionsMissing: "Предположения: не записаны", proposalBase: "На основе версии", expires: "Истекает", confirming: "Подтверждаем…", confirm: "Подтвердить изменение", rejecting: "Отклоняем…", reject: "Отклонить Proposal", reviseLabel: "Изменить предложенное название", revising: "Создаём редакцию…", revise: "Создать редакцию", noPendingTitle: "Нет ожидающего Proposal", noPendingBody: "Каждое новое изменение должно сначала появиться здесь как видимый Proposal.", restoreReady: "Восстановление до версии готово", restoreBody: "Это создаёт новую версию из записанного снимка и не меняет существующие события или версии.", confirmRestore: "Подтвердить восстановление", keepCurrent: "Оставить текущую версию", historyEyebrow: "История версий", confirmedChanges: "Подтверждённые изменения", noChanges: "Для этой поездки ещё нет подтверждённых изменений.", initialVersion: "Начальная версия", version: "Версия", confirmed: "подтверждена", initialBody: "Неизменяемая база этой поездки.", confirmedBody: "Применено через неизменяемый Proposal.", recorded: "Записано", inspectOrigin: "Показать исходный Proposal", proposalId: "ID Proposal:", memoryProvenance: "Происхождение памяти", hardConstraint: "Жёсткое ограничение", preference: "Предпочтение", memorySource: "Источник памяти", receipt: "квитанция", preparing: "Подготовка…", restore: "Восстановить как", integrityEyebrow: "Целостность", integrityTitle: "Одна текущая вершина", integrityBody: "Шкала и текущая версия читают один источник поездки, доступный владельцу. Нет резервных тестовых данных и прямого действия записи." },
  ar: { home: "الصفحة الرئيسية لـ VisePanda", back: "العودة إلى VisePanda", language: "لغة الواجهة", title: "Trip Canvas", signInBody: "سجّل الدخول لقراءة النسخة الحالية من هذه الرحلة.", signIn: "تسجيل الدخول", loading: "جارٍ تحميل النسخة الحالية…", unavailable: "هذه الرحلة غير متاحة.", eyebrow: "Trip Canvas · خط زمني أساسي", lede: "تعرض هذه الصفحة الرحلة الحالية وسجل نسخها المؤكدة. لكل تغيير مسجل مصدر Proposal ثابت، ويبقى السجل إضافياً فقط.", currentVersion: "النسخة الحالية", updated: "حُدّث", rollbackNotice: "الاستعادة ليست إعادة كتابة. تنشئ الاستعادة Proposal جديداً أولاً؛ ولا تنشأ النسخة التالية إلا بتأكيد صريح.", proposalRefreshed: "أُعيدت قراءة أحدث حالة موثوقة للرحلة.", proposalConflict: "تغيّر هذا Proposal أو لم يعد قابلاً للتأكيد. راجع أحدث حالة.", pendingEyebrow: "تغيير قيد الانتظار", pendingTitle: "فرق Proposal", pendingBody: "راجع القيمة القديمة والجديدة أولاً. لا تُكتب الرحلة قبل التأكيد.", before: "القيمة الحالية", after: "القيمة الجديدة المقترحة", evidenceMissing: "الأدلة: غير مسجلة", assumptionsMissing: "الافتراضات: غير مسجلة", proposalBase: "استناداً إلى النسخة", expires: "تنتهي", confirming: "جارٍ التأكيد…", confirm: "تأكيد التغيير", rejecting: "جارٍ الرفض…", reject: "رفض Proposal", reviseLabel: "تعديل العنوان المقترح", revising: "جارٍ إنشاء مراجعة…", revise: "إنشاء مراجعة", noPendingTitle: "لا يوجد Proposal قيد الانتظار", noPendingBody: "يجب أن يصل كل تغيير جديد إلى هنا أولاً كـ Proposal مرئي.", restoreReady: "الاستعادة إلى النسخة جاهزة", restoreBody: "ينشئ هذا نسخة جديدة من اللقطة المسجلة ولا يغيّر أي حدث أو نسخة موجودة.", confirmRestore: "تأكيد الاستعادة", keepCurrent: "الاحتفاظ بالنسخة الحالية", historyEyebrow: "سجل النسخ", confirmedChanges: "التغييرات المؤكدة", noChanges: "لا توجد تغييرات مؤكدة مسجلة لهذه الرحلة بعد.", initialVersion: "النسخة الأولية", version: "النسخة", confirmed: "مؤكدة", initialBody: "الخط الأساسي الثابت لهذه الرحلة.", confirmedBody: "طُبّق عبر Proposal ثابت.", recorded: "سُجل", inspectOrigin: "فحص Proposal المصدر", proposalId: "معرّف Proposal:", memoryProvenance: "مصدر الذاكرة", hardConstraint: "قيد صارم", preference: "تفضيل", memorySource: "مصدر الذاكرة", receipt: "إيصال", preparing: "جارٍ التحضير…", restore: "استعادة كـ", integrityEyebrow: "السلامة", integrityTitle: "رأس حالي واحد", integrityBody: "يقرأ الخط الزمني والنسخة الحالية مصدر الرحلة نفسه المقصور على المالك. لا يوجد بديل تجريبي ولا إجراء كتابة مباشر." },
};

export const tripProposalNoticeCopy: Readonly<Record<Locale, string>> = {
  zh: "待确认提案暂不可用；当前行程仍为权威状态。",
  en: "The pending Proposal is unavailable; the current Trip remains authoritative.",
  es: "La Propuesta pendiente no está disponible; el viaje actual sigue siendo autoritativo.",
  ru: "Ожидающий Proposal недоступен; текущая поездка остаётся авторитетной.",
  ar: "Proposal المعلّق غير متاح؛ تظل الرحلة الحالية هي الحالة الموثوقة.",
};

export const tripPlaceCopy: Readonly<Record<Locale, Readonly<{
  eyebrow: string; title: string; schematic: string; loading: string; empty: string; canonical: string; recheck: string; recorded: string; ask: string; user: string;
}>>> = {
  zh: { eyebrow: "地点视图", title: "精确引用", schematic: "仅示意 · 没有地图提供商或实时路线数据。", loading: "正在读取地点引用…", empty: "此行程尚未记录地点引用。", canonical: "规范地点", recheck: "需要重新核验", recorded: "已记录引用", ask: "询问这个精确地点", user: "用户引用 — 不推断 POI 身份" },
  en: { eyebrow: "Place view", title: "Exact references", schematic: "Schematic only · no map provider or live route data.", loading: "Loading place references…", empty: "No Trip place references have been recorded.", canonical: "Canonical place", recheck: "Recheck required", recorded: "Recorded reference", ask: "Ask about this exact place", user: "User reference — POI identity not inferred" },
  es: { eyebrow: "Vista de lugares", title: "Referencias exactas", schematic: "Solo esquema · sin proveedor de mapas ni datos de ruta en vivo.", loading: "Cargando referencias de lugares…", empty: "No se han registrado referencias de lugares para este viaje.", canonical: "Lugar canónico", recheck: "Requiere verificación", recorded: "Referencia registrada", ask: "Preguntar por este lugar exacto", user: "Referencia del usuario — no se infiere la identidad del POI" },
  ru: { eyebrow: "Просмотр мест", title: "Точные ссылки", schematic: "Только схема · без картографического провайдера и данных маршрута в реальном времени.", loading: "Загружаются ссылки на места…", empty: "Для этой поездки ещё нет записанных ссылок на места.", canonical: "Каноническое место", recheck: "Требуется перепроверка", recorded: "Записанная ссылка", ask: "Спросить об этом точном месте", user: "Ссылка пользователя — идентичность POI не выводится" },
  ar: { eyebrow: "عرض الأماكن", title: "مراجع دقيقة", schematic: "مخطط فقط · لا يوجد مزود خرائط أو بيانات مسار مباشرة.", loading: "جارٍ تحميل مراجع الأماكن…", empty: "لم تُسجل مراجع أماكن لهذه الرحلة.", canonical: "مكان أساسي", recheck: "يلزم التحقق مجدداً", recorded: "مرجع مسجل", ask: "اسأل عن هذا المكان الدقيق", user: "مرجع المستخدم — لا تُستنتج هوية POI" },
};

export const tripActionsCopy: Readonly<Record<Locale, Readonly<{
  eyebrow: string; title: string; schematic: string; unavailable: string; loading: string; empty: string; recheck: string; missingLink: string; recordedLink: string; source: string; open: string;
}>>> = {
  zh: { eyebrow: "预订与操作", title: "准备并交接", schematic: "这里不会创建订单、付款、库存或提供商完成状态。", unavailable: "已记录操作暂不可用。", loading: "正在读取已记录操作…", empty: "尚未记录票务、预订、外部链接或准备引用。", recheck: "需要重新核验", missingLink: "不可用 — 没有已记录的外部链接", recordedLink: "已记录外部链接可用", source: "来源：行程记录", open: "打开已记录的外部链接" },
  en: { eyebrow: "Reservations & Actions", title: "Prepare and hand off", schematic: "No orders, payments, inventory, or provider completion are created here.", unavailable: "Recorded actions are unavailable right now.", loading: "Loading recorded actions…", empty: "No ticket, reservation, external-link, or preparation reference has been recorded.", recheck: "Recheck required", missingLink: "Unavailable — no recorded external link", recordedLink: "Recorded external link available", source: "Source: Trip record", open: "Open recorded external link" },
  es: { eyebrow: "Reservas y acciones", title: "Preparar y entregar", schematic: "Aquí no se crean pedidos, pagos, inventario ni finalizaciones de proveedores.", unavailable: "Las acciones registradas no están disponibles ahora.", loading: "Cargando acciones registradas…", empty: "No se ha registrado ninguna referencia de billete, reserva, enlace externo o preparación.", recheck: "Requiere verificación", missingLink: "No disponible — no hay enlace externo registrado", recordedLink: "Enlace externo registrado disponible", source: "Fuente: registro del viaje", open: "Abrir enlace externo registrado" },
  ru: { eyebrow: "Бронирования и действия", title: "Подготовить и передать", schematic: "Здесь не создаются заказы, платежи, инвентарь или завершения у провайдера.", unavailable: "Записанные действия сейчас недоступны.", loading: "Загружаются записанные действия…", empty: "Не записаны ни билет, ни бронь, ни внешняя ссылка, ни подготовительная ссылка.", recheck: "Требуется перепроверка", missingLink: "Недоступно — нет записанной внешней ссылки", recordedLink: "Записанная внешняя ссылка доступна", source: "Источник: запись поездки", open: "Открыть записанную внешнюю ссылку" },
  ar: { eyebrow: "الحجوزات والإجراءات", title: "التحضير والتسليم", schematic: "لا تُنشأ هنا طلبات أو مدفوعات أو مخزون أو إكمال من مزود.", unavailable: "الإجراءات المسجلة غير متاحة الآن.", loading: "جارٍ تحميل الإجراءات المسجلة…", empty: "لم يُسجل مرجع تذكرة أو حجز أو رابط خارجي أو تحضير.", recheck: "يلزم التحقق مجدداً", missingLink: "غير متاح — لا يوجد رابط خارجي مسجل", recordedLink: "الرابط الخارجي المسجل متاح", source: "المصدر: سجل الرحلة", open: "فتح الرابط الخارجي المسجل" },
};
...
export const chatThreadCopy: Readonly<Record<Locale, Readonly<{
  ...
  feedback: string; anotherOption: string; inaccurate: string; rejectReason: string; correction: string; feedbackSaved: string;
  tripScope: string; noTripScope: string; composerLabel: string; composerUnavailable: string;
  resultTypes: readonly [string, string, string, string, string, string];
}>>> = {
  zh: { title: "聊天线程", eyebrow: "咨询 · 私有历史", body: "仅登录用户可查看自己的线程元数据。状态控制不会提交提示词、调用 AI 或写入行程。", create: "新建私有线程", loading: "正在读取你的线程…", empty: "还没有线程。新建线程不会自动发送消息。", noTurns: "尚未开始 Turn。", signIn: "登录后查看私有线程", unavailable: "线程暂不可用，请稍后再试。", back: "返回工作台", language: "界面语言", state: "线程状态", active: "进行中", archived: "已归档", recorded: "条已记录的状态事件", startTurn: "开始受限 Turn", cancelTurn: "取消 Turn", starting: "正在开始…", cancelling: "正在取消…", feedback: "结果反馈", anotherOption: "换一种方案", inaccurate: "内容不准确", rejectReason: "拒绝原因", correction: "需要更正", feedbackSaved: "已记录结构化反馈。", tripScope: "关联 Trip（可选）", noTripScope: "不关联 Trip", composerLabel: "消息输入", composerUnavailable: "真实文本 Provider 尚未配置，无法发送消息。", resultTypes: ["需要补充", "回答", "卡片", "提案待确认", "暂不可用", "存在冲突"] },
  en: { title: "Chat threads", eyebrow: "Ask · private history", body: "Only signed-in users can view their own thread metadata. State controls never submit prompts, call AI, or write a Trip.", create: "Start a private thread", loading: "Loading your threads…", empty: "There are no threads yet. Creating one never sends a message automatically.", noTurns: "No Turn has started.", signIn: "Sign in to view private threads", unavailable: "Threads are unavailable right now. Please try again later.", back: "Back to workspace", language: "Interface language", state: "Thread state", active: "Active", archived: "Archived", recorded: "recorded state events", startTurn: "Start a bounded Turn", cancelTurn: "Cancel Turn", starting: "Starting…", cancelling: "Cancelling…", feedback: "Result feedback", anotherOption: "Another option", inaccurate: "Inaccurate", rejectReason: "Reject reason", correction: "Needs correction", feedbackSaved: "Structured feedback saved.", tripScope: "Trip scope (optional)", noTripScope: "No Trip scope", composerLabel: "Message input", composerUnavailable: "A live text Provider is not configured, so messages cannot be sent.", resultTypes: ["Needs input", "Answer", "Card", "Proposal ready", "Unavailable", "Conflict"] },
  es: { title: "Hilos de chat", eyebrow: "Consultar · historial privado", body: "Solo quienes han iniciado sesión pueden ver los metadatos de sus propios hilos. Los controles de estado no envían prompts, no llaman a IA ni modifican un viaje.", create: "Crear hilo privado", loading: "Cargando tus hilos…", empty: "Aún no hay hilos. Crear uno nunca envía un mensaje automáticamente.", noTurns: "Aún no ha empezado ningún Turn.", signIn: "Inicia sesión para ver hilos privados", unavailable: "Los hilos no están disponibles ahora. Inténtalo más tarde.", back: "Volver al espacio", language: "Idioma de la interfaz", state: "Estado del hilo", active: "Activo", archived: "Archivado", recorded: "eventos de estado registrados", startTurn: "Iniciar Turn limitado", cancelTurn: "Cancelar Turn", starting: "Iniciando…", cancelling: "Cancelando…", feedback: "Comentarios del resultado", anotherOption: "Otra opción", inaccurate: "Inexacto", rejectReason: "Motivo de rechazo", correction: "Necesita corrección", feedbackSaved: "Comentarios estructurados guardados.", tripScope: "Trip asociado (opcional)", noTripScope: "Sin Trip asociado", composerLabel: "Entrada de mensaje", composerUnavailable: "No hay un proveedor de texto en vivo configurado; no se pueden enviar mensajes.", resultTypes: ["Necesita datos", "Respuesta", "Tarjeta", "Propuesta lista", "No disponible", "Conflicto"] },
  ru: { title: "Чаты", eyebrow: "Спросить · приватная история", body: "Только вошедшие пользователи видят метаданные своих чатов. Управление состоянием не отправляет запросы, не вызывает ИИ и не меняет поездку.", create: "Создать приватный чат", loading: "Загружаем ваши чаты…", empty: "Чатов пока нет. Создание чата не отправляет сообщение автоматически.", noTurns: "Ни один Turn ещё не начат.", signIn: "Войдите, чтобы увидеть приватные чаты", unavailable: "Чаты сейчас недоступны. Повторите позже.", back: "Вернуться в рабочее пространство", language: "Язык интерфейса", state: "Состояние чата", active: "Активен", archived: "В архиве", recorded: "записанных событий состояния", startTurn: "Начать ограниченный Turn", cancelTurn: "Отменить Turn", starting: "Запускаем…", cancelling: "Отменяем…", feedback: "Отзыв о результате", anotherOption: "Другой вариант", inaccurate: "Неточно", rejectReason: "Причина отказа", correction: "Нужна правка", feedbackSaved: "Структурированный отзыв сохранён.", tripScope: "Связанный Trip (необязательно)", noTripScope: "Без связанного Trip", composerLabel: "Ввод сообщения", composerUnavailable: "Поставщик текста в реальном времени не настроен, сообщения нельзя отправить.", resultTypes: ["Нужны данные", "Ответ", "Карточка", "Предложение готово", "Недоступно", "Конфликт"] },
  ar: { title: "سلاسل المحادثة", eyebrow: "اسأل · سجل خاص", body: "لا يرى بيانات سلاسله إلا المستخدمون المسجلون. لا ترسل عناصر التحكم بالحالة المطالبات ولا تستدعي الذكاء الاصطناعي ولا تغيّر الرحلة.", create: "إنشاء سلسلة خاصة", loading: "جارٍ تحميل سلاسلك…", empty: "لا توجد سلاسل بعد. إنشاؤها لا يرسل رسالة تلقائياً.", noTurns: "لم يبدأ أي Turn بعد.", signIn: "سجّل الدخول لعرض السلاسل الخاصة", unavailable: "السلاسل غير متاحة الآن. حاول لاحقاً.", back: "العودة إلى مساحة العمل", language: "لغة الواجهة", state: "حالة السلسلة", active: "نشطة", archived: "مؤرشفة", recorded: "أحداث حالة مسجلة", startTurn: "بدء Turn محدود", cancelTurn: "إلغاء Turn", starting: "جارٍ البدء…", cancelling: "جارٍ الإلغاء…", feedback: "ملاحظات النتيجة", anotherOption: "خيار آخر", inaccurate: "غير دقيق", rejectReason: "سبب الرفض", correction: "يحتاج إلى تصحيح", feedbackSaved: "تم حفظ ملاحظات منظمة.", tripScope: "نطاق Trip (اختياري)", noTripScope: "بلا نطاق Trip", composerLabel: "إدخال الرسالة", composerUnavailable: "موفر النص المباشر غير مهيأ، لذلك لا يمكن إرسال الرسائل.", resultTypes: ["تحتاج معلومات", "إجابة", "بطاقة", "اقتراح جاهز", "غير متاح", "تعارض"] },
};

export const chatThreadWorkspaceCopy: Readonly<Record<Locale, Readonly<{
  exactPlaceScope: string; memoryProvenance: string; hardConstraint: string; preference: string; memorySource: string; receipt: string;
}>>> = {
  zh: { exactPlaceScope: "精确地点范围：{poiId}。此不透明 ID 不会提交提示词或推断地点事实。", memoryProvenance: "记忆来源", hardConstraint: "硬性限制", preference: "偏好", memorySource: "记忆来源", receipt: "收据" },
  en: { exactPlaceScope: "Exact place scope: {poiId}. This opaque ID does not submit a prompt or infer place facts.", memoryProvenance: "Memory provenance", hardConstraint: "Hard constraint", preference: "Preference", memorySource: "Memory source", receipt: "receipt" },
  es: { exactPlaceScope: "Alcance exacto del lugar: {poiId}. Este ID opaco no envía un prompt ni infiere datos del lugar.", memoryProvenance: "Procedencia de la memoria", hardConstraint: "Restricción estricta", preference: "Preferencia", memorySource: "Fuente de memoria", receipt: "recibo" },
  ru: { exactPlaceScope: "Точная область места: {poiId}. Этот непрозрачный ID не отправляет запрос и не выводит факты о месте.", memoryProvenance: "Источник памяти", hardConstraint: "Жёсткое ограничение", preference: "Предпочтение", memorySource: "Источник памяти", receipt: "квитанция" },
...
export const failureCopy: Readonly<Record<Locale, Readonly<Record<FailureCode, string>>>> = {
  zh: failureMessages(["请先登录后继续。", "你没有执行此操作的权限。", "请求过于频繁，请稍后再试。", "请检查输入后重试。", "此文件类型暂不支持。", "需要先确认具体范围。", "没有可用的合格证据。", "数据政策不允许此操作。", "相关信息已过期，请重新核实。", "服务暂时不可用，请稍后重试。", "请求超时，尚未产生结果。", "请求超时，结果状态不确定。", "结果未通过验证，请重试。", "为保证安全，此请求未被执行。", "当前额度已用尽，请稍后再试。", "请求已取消。", "行程已更新，请检查最新版本。", "该提案目前无法确认。", "此请求键已用于不同内容。", "任务状态已更新，请重新加载后继续。", "这条记忆已变化，请读取最新版本。", "数据正在更新，请稍后重试。", "发生了意外错误，请稍后再试。"]),
  en: failureMessages(["Please sign in to continue.", "You do not have permission for this action.", "Too many requests. Please try again later.", "Check your input and try again.", "This media type is not supported.", "Please clarify the scope first.", "No eligible evidence is available.", "Data policy does not allow this action.", "This information has expired; please recheck it.", "The service is temporarily unavailable.", "The request timed out before a result was produced.", "The request timed out and the result state is uncertain.", "The result did not pass validation.", "This request was not completed for safety.", "Your current budget is exhausted.", "The request was cancelled.", "The trip changed; review the latest version.", "This proposal can no longer be confirmed.", "This request key was used with different content.", "The task state changed. Reload before continuing.", "This memory changed; load its latest version.", "Data is updating; please try again shortly.", "An unexpected error occurred. Please try again."]),
  es: failureMessages(["Inicia sesión para continuar.", "No tienes permiso para esta acción.", "Demasiadas solicitudes. Inténtalo más tarde.", "Revisa la entrada e inténtalo de nuevo.", "Este tipo de archivo no es compatible.", "Primero aclara el alcance.", "No hay evidencia válida disponible.", "La política de datos no permite esta acción.", "Esta información ha caducado; vuelve a verificarla.", "El servicio no está disponible temporalmente.", "La solicitud agotó el tiempo antes de producir un resultado.", "La solicitud agotó el tiempo y el resultado es incierto.", "El resultado no superó la validación.", "Esta solicitud no se completó por seguridad.", "Tu cuota actual se ha agotado.", "La solicitud se canceló.", "El viaje cambió; revisa la versión más reciente.", "Esta propuesta ya no se puede confirmar.", "Esta clave de solicitud se usó con contenido distinto.", "El estado de la tarea cambió. Recarga antes de continuar.", "Esta memoria cambió; carga la versión más reciente.", "Los datos se están actualizando; inténtalo pronto.", "Ocurrió un error inesperado. Inténtalo de nuevo."]),
  ru: failureMessages(["Войдите, чтобы продолжить.", "У вас нет прав для этого действия.", "Слишком много запросов. Повторите позже.", "Проверьте ввод и повторите попытку.", "Этот тип файла не поддерживается.", "Сначала уточните область запроса.", "Нет подходящих подтверждённых данных.", "Политика данных не разрешает это действие.", "Эти сведения устарели; проверьте их снова.", "Сервис временно недоступен.", "Время ожидания истекло до получения результата.", "Время ожидания истекло, статус результата неизвестен.", "Результат не прошёл проверку.", "Запрос не выполнен из соображений безопасности.", "Текущий лимит исчерпан.", "Запрос отменён.", "Поездка изменилась; проверьте последнюю версию.", "Это предложение больше нельзя подтвердить.", "Этот ключ запроса использован с другим содержимым.", "Состояние задачи изменилось. Обновите данные перед продолжением.", "Эта запись памяти изменилась; загрузите последнюю версию.", "Данные обновляются; повторите попытку позже.", "Произошла непредвиденная ошибка. Повторите позже."]),
  ar: failureMessages(["سجّل الدخول للمتابعة.", "ليس لديك إذن لهذا الإجراء.", "عدد الطلبات كبير، حاول لاحقاً.", "راجع الإدخال ثم حاول مجدداً.", "نوع الملف غير مدعوم.", "يرجى توضيح النطاق أولاً.", "لا تتوفر أدلة مؤهلة.", "سياسة البيانات لا تسمح بهذا الإجراء.", "انتهت صلاحية هذه المعلومات؛ تحقق منها مجدداً.", "الخدمة غير متاحة مؤقتاً.", "انتهت مهلة الطلب قبل ظهور نتيجة.", "انتهت المهلة وحالة النتيجة غير مؤكدة.", "لم تجتز النتيجة التحقق.", "لم يكتمل الطلب لأسباب تتعلق بالسلامة.", "تم استهلاك الحصة الحالية.", "تم إلغاء الطلب.", "تغيّرت الرحلة؛ راجع أحدث إصدار.", "لم يعد بالإمكان تأكيد هذا الاقتراح.", "استُخدم مفتاح الطلب هذا مع محتوى مختلف.", "تغيرت حالة المهمة. أعد التحميل قبل المتابعة.", "تغيّرت هذه الذاكرة؛ حمّل أحدث نسخة.", "تجري تحديثات للبيانات؛ حاول قريباً.", "حدث خطأ غير متوقع. حاول مرة أخرى."]),
};

export const tripLocalEditorCopy = {
  zh: { rejected: "提议已拒绝，已确认内容未改变。", proposalRevision: "提议修订", proposalBase: "提议基于版本", createTrip: "创建行程", title: "同一行程", confirmed: "已确认内容", initial: "初始行程", unknown: "确认状态未知", draft: "未提交草稿", base: "草稿基于版本", tripTitle: "行程名称", date: "日期", itemTitle: "事项名称", addDay: "添加一天", addItem: "添加事项", remove: "移除", review: "生成变更提议", revise: "修订提议", reload: "读取最新版本", reset: "明确放弃草稿并从最新重建", conflict: "服务器版本已变化。你的草稿仍保留；请核对最新内容，或明确放弃后重建。", unavailable: "暂时无法完成，请重试。草稿已保留。", pending: "待确认的变更", confirm: "确认这些变更", reject: "拒绝提议", noChanges: "尚无待提交编辑", stored: "已确认并重载服务器版本", locksNotEnabled: "用户硬锁：此版本未启用", locksUnknown: "用户硬锁：状态未知", ordersNotConnected: "外部订单：未接入，不能据此判断是否存在订单", ordersUnknown: "外部订单状态：未知", legacyHistory: "部分历史记录无法核验，未标记为已确认。", unverifiedVersion: "历史记录（未核验）", localOnly: "测试环境：两端使用同一行程；变更须明确确认。", before: "变更前", after: "变更后", newItem: "新事项" },
  en: { rejected: "Proposal rejected. Confirmed content is unchanged.", proposalRevision: "Proposal revision", proposalBase: "Proposal base version", createTrip: "Create Trip", title: "Same Trip", confirmed: "Confirmed content", initial: "Initial Trip", unknown: "Confirmation state unknown", draft: "Unsubmitted draft", base: "Draft base version", tripTitle: "Trip title", date: "Date", itemTitle: "Item title", addDay: "Add day", addItem: "Add item", remove: "Remove", review: "Create change proposal", revise: "Revise proposal", reload: "Load latest version", reset: "Discard draft and rebuild from latest", conflict: "The server version changed. Your draft is preserved; review the latest content or explicitly discard and rebuild.", unavailable: "Unavailable for now. Retry; your draft is preserved.", pending: "Changes awaiting confirmation", confirm: "Confirm these changes", reject: "Reject proposal", noChanges: "No edits to submit", stored: "Confirmed and reloaded the server version", locksNotEnabled: "User hard locks: not enabled in this version", locksUnknown: "User hard locks: state unknown", ordersNotConnected: "External orders: not connected; this cannot tell you whether an order exists", ordersUnknown: "External order state: unknown", legacyHistory: "Some historical records cannot be verified and are not labeled confirmed.", unverifiedVersion: "Historical record (unverified)", localOnly: "Test environment: both clients use the same Trip; changes require explicit confirmation.", before: "Before", after: "After", newItem: "New item" },
  es: { rejected: "Propuesta rechazada. El contenido confirmado no ha cambiado.", proposalRevision: "Revisión de propuesta", proposalBase: "Versión base de la propuesta", createTrip: "Crear viaje", title: "Mismo viaje", confirmed: "Contenido confirmado", initial: "Viaje inicial", unknown: "Estado de confirmación desconocido", draft: "Borrador sin enviar", base: "Versión base del borrador", tripTitle: "Nombre del viaje", date: "Fecha", itemTitle: "Nombre de la actividad", addDay: "Añadir día", addItem: "Añadir actividad", remove: "Eliminar", review: "Crear propuesta de cambios", revise: "Revisar propuesta", reload: "Cargar última versión", reset: "Descartar borrador y empezar desde la última versión", conflict: "La versión del servidor cambió. Se conserva tu borrador; revisa el contenido más reciente o descártalo explícitamente para empezar de nuevo.", unavailable: "No disponible por ahora. Reinténtalo; tu borrador se conserva.", pending: "Cambios pendientes de confirmación", confirm: "Confirmar estos cambios", reject: "Rechazar propuesta", noChanges: "No hay cambios que enviar", stored: "Confirmado y recargado desde el servidor", locksNotEnabled: "Bloqueos del usuario: no habilitados en esta versión", locksUnknown: "Bloqueos del usuario: estado desconocido", ordersNotConnected: "Pedidos externos: no conectados; esto no indica si existe un pedido", ordersUnknown: "Estado de pedidos externos: desconocido", legacyHistory: "Algunos registros históricos no se pueden verificar y no se marcan como confirmados.", unverifiedVersion: "Registro histórico (sin verificar)", localOnly: "Entorno de prueba: ambos clientes usan el mismo viaje; los cambios requieren confirmación explícita.", before: "Antes", after: "Después", newItem: "Nueva actividad" },
  ru: { rejected: "Предложение отклонено. Подтверждённые данные не изменились.", proposalRevision: "Редакция предложения", proposalBase: "Базовая версия предложения", createTrip: "Создать поездку", title: "Одна поездка", confirmed: "Подтверждённые данные", initial: "Начальная поездка", unknown: "Статус подтверждения неизвестен", draft: "Неотправленный черновик", base: "Базовая версия черновика", tripTitle: "Название поездки", date: "Дата", itemTitle: "Название пункта", addDay: "Добавить день", addItem: "Добавить пункт", remove: "Удалить", review: "Создать предложение изменений", revise: "Изменить предложение", reload: "Загрузить последнюю версию", reset: "Отменить черновик и начать с последней версии", conflict: "Версия на сервере изменилась. Черновик сохранён; проверьте новые данные или явно отмените его и начните заново.", unavailable: "Пока недоступно. Повторите попытку; черновик сохранён.", pending: "Изменения ожидают подтверждения", confirm: "Подтвердить эти изменения", reject: "Отклонить предложение", noChanges: "Нет изменений для отправки", stored: "Подтверждено и загружено с сервера", locksNotEnabled: "Жёсткие ограничения пользователя: не включены в этой версии", locksUnknown: "Жёсткие ограничения пользователя: состояние неизвестно", ordersNotConnected: "Внешние заказы: не подключены; это не говорит о наличии заказа", ordersUnknown: "Статус внешних заказов: неизвестен", legacyHistory: "Некоторые исторические записи нельзя проверить; они не отмечены как подтверждённые.", unverifiedVersion: "Историческая запись (не проверена)", localOnly: "Тестовая среда: оба клиента используют одну поездку; изменения требуют явного подтверждения.", before: "До", after: "После", newItem: "Новый пункт" },
  ar: { rejected: "تم رفض المقترح. لم يتغير المحتوى المؤكد.", proposalRevision: "مراجعة المقترح", proposalBase: "الإصدار الأساسي للمقترح", createTrip: "إنشاء رحلة", title: "الرحلة نفسها", confirmed: "المحتوى المؤكد", initial: "رحلة أولية", unknown: "حالة التأكيد غير معروفة", draft: "مسودة غير مرسلة", base: "الإصدار الأساسي للمسودة", tripTitle: "اسم الرحلة", date: "التاريخ", itemTitle: "اسم النشاط", addDay: "إضافة يوم", addItem: "إضافة نشاط", remove: "إزالة", review: "إنشاء مقترح تغييرات", revise: "تعديل المقترح", reload: "تحميل أحدث إصدار", reset: "تجاهل المسودة والبدء من أحدث إصدار", conflict: "تغير إصدار الخادم. مسودتك محفوظة؛ راجع أحدث محتوى أو تجاهل المسودة صراحة وابدأ من جديد.", unavailable: "غير متاح حاليًا. حاول مجددًا؛ مسودتك محفوظة.", pending: "تغييرات تنتظر التأكيد", confirm: "تأكيد هذه التغييرات", reject: "رفض المقترح", noChanges: "لا توجد تعديلات لإرسالها", stored: "تم التأكيد وإعادة التحميل من الخادم", locksNotEnabled: "قيود المستخدم الصارمة: غير مفعلة في هذا الإصدار", locksUnknown: "قيود المستخدم الصارمة: الحالة غير معروفة", ordersNotConnected: "الطلبات الخارجية: غير متصلة؛ لا يحدد ذلك وجود طلب", ordersUnknown: "حالة الطلبات الخارجية: غير معروفة", legacyHistory: "لا يمكن التحقق من بعض السجلات السابقة ولا تُعرض كمؤكدة.", unverifiedVersion: "سجل سابق (غير متحقق منه)", localOnly: "بيئة اختبار: يستخدم العميلان الرحلة نفسها؛ تتطلب التغييرات تأكيداً صريحاً.", before: "قبل", after: "بعد", newItem: "نشاط جديد" },
} satisfies Record<Locale, Record<string, string>>;

/** Private Ops candidate workspace; reviewed does not imply publication. */
export const opsReviewCopy = {
  zh: { heading: "候选内容审核", boundary: "私有工作区。审核通过后仍未发布，也不能用于检索。", login: "登录或切换账号", refresh: "刷新", title: "标题", content: "候选正文", submit: "提交候选", note: "审核说明", reviewed: "审核通过", rejected: "驳回", pending: "待审核", submitted: "已提交", empty: "暂无候选内容。", unavailable: "工作区不可用，请检查登录与访问资格后重试。", busy: "处理中…", author: "作者", reviewer: "审核人", audit: "审计记录", self: "请由另一位成员审核。", language: "语言", success: "操作已保存。", unknown: "结果尚未确认。请重试同一操作以确认结果。", retry: "重试同一操作" },
  en: { heading: "Candidate review", boundary: "Private workspace. Reviewed content remains unpublished and unavailable for retrieval.", login: "Sign in or switch account", refresh: "Refresh", title: "Title", content: "Candidate text", submit: "Submit candidate", note: "Review note", reviewed: "Reviewed", rejected: "Rejected", pending: "Pending review", submitted: "Submitted", empty: "No candidates yet.", unavailable: "Workspace unavailable. Check your sign-in and access, then retry.", busy: "Working…", author: "Author", reviewer: "Reviewer", audit: "Audit history", self: "Another member must review this candidate.", language: "Language", success: "Changes saved.", unknown: "The result is not yet confirmed. Retry the same operation to confirm it.", retry: "Retry same operation" },
  es: { heading: "Revisión de candidatos", boundary: "Espacio privado. El contenido revisado sigue sin publicarse y no está disponible para recuperación.", login: "Iniciar sesión o cambiar de cuenta", refresh: "Actualizar", title: "Título", content: "Texto candidato", submit: "Enviar candidato", note: "Nota de revisión", reviewed: "Revisado", rejected: "Rechazado", pending: "Pendiente de revisión", submitted: "Enviado", empty: "Todavía no hay candidatos.", unavailable: "Espacio no disponible. Comprueba tu sesión y acceso e inténtalo de nuevo.", busy: "Procesando…", author: "Autor", reviewer: "Revisor", audit: "Historial de auditoría", self: "Otro miembro debe revisar este candidato.", language: "Idioma", success: "Cambios guardados.", unknown: "El resultado aún no está confirmado. Reintenta la misma operación para confirmarlo.", retry: "Reintentar la misma operación" },
  ru: { heading: "Проверка материалов", boundary: "Закрытая рабочая область. Проверенные материалы не опубликованы и недоступны для поиска.", login: "Войти или сменить аккаунт", refresh: "Обновить", title: "Заголовок", content: "Текст материала", submit: "Отправить материал", note: "Комментарий проверяющего", reviewed: "Проверено", rejected: "Отклонено", pending: "Ожидает проверки", submitted: "Отправлено", empty: "Материалов пока нет.", unavailable: "Рабочая область недоступна. Проверьте вход и права доступа и повторите попытку.", busy: "Обработка…", author: "Автор", reviewer: "Проверяющий", audit: "Журнал аудита", self: "Материал должен проверить другой участник.", language: "Язык", success: "Изменения сохранены.", unknown: "Результат ещё не подтверждён. Повторите ту же операцию для проверки.", retry: "Повторить ту же операцию" },
  ar: { heading: "مراجعة المحتوى المرشح", boundary: "مساحة عمل خاصة. يظل المحتوى المراجع غير منشور وغير متاح للاسترجاع.", login: "تسجيل الدخول أو تبديل الحساب", refresh: "تحديث", title: "العنوان", content: "النص المرشح", submit: "إرسال المحتوى", note: "ملاحظة المراجعة", reviewed: "تمت المراجعة", rejected: "مرفوض", pending: "بانتظار المراجعة", submitted: "تم الإرسال", empty: "لا يوجد محتوى مرشح بعد.", unavailable: "مساحة العمل غير متاحة. تحقق من تسجيل الدخول وصلاحية الوصول ثم أعد المحاولة.", busy: "جارٍ التنفيذ…", author: "المؤلف", reviewer: "المراجع", audit: "سجل التدقيق", self: "يجب أن يراجع هذا المحتوى عضو آخر.", language: "اللغة", success: "تم حفظ التغييرات.", unknown: "لم يتم تأكيد النتيجة بعد. أعد محاولة العملية نفسها لتأكيدها.", retry: "إعادة محاولة العملية نفسها" },
} as const satisfies Record<Locale, Record<string, string>>;

export const opsSourceCopy = {
 zh: { mode: "登记来源与双语地址草稿", boundary: "仅保存待审声明。定位器和用途说明未经核验；审核不授予发布或检索资格。", source: "来源片段", sourceKey: "来源标识", revisionLabel: "来源修订标签", publisher: "来源署名", uri: "来源文档 URI", locator: "片段定位器", snippet: "所提供的原文片段", usageDeclaration: "待审用途与许可说明", subjectId: "待审主体标识", lines: "规范地址（每行一项，最多三行）", locality: "地址所属地区", countryCode: "国家代码（两位大写字母）", zh: "中文人工表达", en: "英文人工表达", details: "来源与双语草稿", hash: "所存片段 SHA256", assertion: "待审 assertion 修订", unverified: "未经核验；未获运行授权" },
 en: { mode: "Register a source and bilingual address draft", boundary: "Pending declarations only. Locator and intended uses are unverified; review grants no publication or retrieval eligibility.", source: "Source excerpt", sourceKey: "Source key", revisionLabel: "Source revision label", publisher: "Source attribution", uri: "Source document URI", locator: "Excerpt locator", snippet: "Supplied source excerpt", usageDeclaration: "Pending use and licence declaration", subjectId: "Pending subject identifier", lines: "Canonical address (one item per line, at most three)", locality: "Address locality", countryCode: "Country code (two uppercase letters)", zh: "Human-written Chinese expression", en: "Human-written English expression", details: "Source and bilingual draft", hash: "Stored excerpt SHA256", assertion: "Pending assertion revision", unverified: "Unverified; no runtime authorization" },
 es: { mode: "Registrar una fuente y un borrador bilingüe de dirección", boundary: "Solo declaraciones pendientes. La ubicación del fragmento y los usos no están verificados; la revisión no autoriza publicación ni recuperación.", source: "Fragmento de la fuente", sourceKey: "Identificador de fuente", revisionLabel: "Etiqueta de revisión", publisher: "Atribución de la fuente", uri: "URI del documento", locator: "Ubicación del fragmento", snippet: "Fragmento original proporcionado", usageDeclaration: "Declaración pendiente de uso y licencia", subjectId: "Identificador del sujeto pendiente", lines: "Dirección canónica (un elemento por línea, máximo tres)", locality: "Localidad de la dirección", countryCode: "Código de país (dos mayúsculas)", zh: "Expresión en chino escrita por una persona", en: "Expresión en inglés escrita por una persona", details: "Fuente y borrador bilingüe", hash: "SHA256 del fragmento guardado", assertion: "Revisión de la afirmación pendiente", unverified: "Sin verificar; sin autorización de uso" },
 ru: { mode: "Зарегистрировать источник и двуязычный черновик адреса", boundary: "Только заявления на проверку. Ссылка на фрагмент и цели использования не проверены; проверка не разрешает публикацию или поиск.", source: "Фрагмент источника", sourceKey: "Идентификатор источника", revisionLabel: "Метка версии источника", publisher: "Авторство источника", uri: "URI документа", locator: "Расположение фрагмента", snippet: "Предоставленный исходный фрагмент", usageDeclaration: "Заявление об использовании и лицензии", subjectId: "Идентификатор проверяемого объекта", lines: "Канонический адрес (по элементу в строке, не более трёх)", locality: "Населённый пункт", countryCode: "Код страны (две заглавные буквы)", zh: "Китайская формулировка, написанная человеком", en: "Английская формулировка, написанная человеком", details: "Источник и двуязычный черновик", hash: "SHA256 сохранённого фрагмента", assertion: "Версия утверждения на проверку", unverified: "Не проверено; использование не разрешено" },
 ar: { mode: "تسجيل مصدر ومسودة عنوان بلغتين", boundary: "تصريحات قيد المراجعة فقط. موضع المقتطف والاستخدامات غير موثقة؛ المراجعة لا تمنح أهلية النشر أو الاسترجاع.", source: "مقتطف المصدر", sourceKey: "معرّف المصدر", revisionLabel: "وسم إصدار المصدر", publisher: "نسبة المصدر", uri: "URI مستند المصدر", locator: "موضع المقتطف", snippet: "المقتطف الأصلي المقدم", usageDeclaration: "تصريح الاستخدام والترخيص قيد المراجعة", subjectId: "معرّف الموضوع قيد المراجعة", lines: "العنوان الأساسي (عنصر في كل سطر، ثلاثة كحد أقصى)", locality: "منطقة العنوان", countryCode: "رمز البلد (حرفان لاتينيان كبيران)", zh: "صياغة صينية كتبها شخص", en: "صياغة إنجليزية كتبها شخص", details: "المصدر والمسودة بلغتين", hash: "SHA256 للمقتطف المحفوظ", assertion: "إصدار الادعاء قيد المراجعة", unverified: "غير موثّق؛ لا يوجد تفويض للاستخدام" },
} as const satisfies Record<Locale, Record<string, string>>;

/** VPJ-74: read-only relation/source/audit lookup for one published fact. */
export const opsProvenanceCopy = {
  zh: { heading: "知识溯源查询", language: "语言", review: "候选内容审核", boundary: "只读工作区。按已发布 factId 查看关系类型、来源版本与发布记录；不能新建、编辑或撤销声明。", login: "登录或切换账号", factId: "Fact ID", lookup: "查询", busy: "查询中…", empty: "输入一个已发布 Fact 的 ID。", unavailable: "查询暂不可用，请检查登录与访问资格后重试。", notFound: "未找到该 Fact，或它尚未发布。", invalid: "Fact ID 格式不正确。", relation: "关系类型", domainType: "主体类型", rangeType: "客体类型", unregistered: "该关系尚未登记（不应出现，如出现请上报）。", subjectId: "主体标识", objectId: "客体标识", predicate: "谓词", sources: "来源", sourceHistory: "同源历史版本", auditTrail: "发布审计记录", sourceKey: "来源标识", revisionLabel: "修订标签", publisher: "署名", uri: "文档 URI", locator: "片段定位", snippetHash: "片段 SHA256", fetchedAt: "抓取/提交时间", effectiveAt: "生效时间", lineageStatus: "血缘状态", legacy: "历史记录（未追踪血缘）", tracked: "已追踪血缘", unknownTime: "未知", state: "发布状态", published: "已发布", revoked: "已撤销", publicationVersion: "发布版本", action: "操作", note: "说明", createdAt: "时间" },
  en: { heading: "Knowledge provenance lookup", language: "Language", review: "Candidate review", boundary: "Read-only workspace. Look up a published fact's relation type, source revisions, and publication record by factId; nothing here can create, edit, or revoke a statement.", login: "Sign in or switch account", factId: "Fact ID", lookup: "Look up", busy: "Looking up…", empty: "Enter a published Fact's ID.", unavailable: "Lookup unavailable. Check your sign-in and access, then retry.", notFound: "That Fact was not found, or is not published.", invalid: "That Fact ID is not a valid identifier.", relation: "Relation", domainType: "Subject type", rangeType: "Object type", unregistered: "This relation is not registered (should not happen; report it).", subjectId: "Subject", objectId: "Object", predicate: "Predicate", sources: "Sources", sourceHistory: "Source revision history", auditTrail: "Publication audit trail", sourceKey: "Source key", revisionLabel: "Revision label", publisher: "Publisher", uri: "Document URI", locator: "Excerpt locator", snippetHash: "Excerpt SHA256", fetchedAt: "Fetched/submitted at", effectiveAt: "Effective at", lineageStatus: "Lineage status", legacy: "Legacy (lineage not tracked)", tracked: "Lineage tracked", unknownTime: "Unknown", state: "State", published: "Published", revoked: "Revoked", publicationVersion: "Publication version", action: "Action", note: "Note", createdAt: "At" },
  es: { heading: "Consulta de procedencia", language: "Idioma", review: "Revisión de candidatos", boundary: "Espacio de solo lectura. Consulta el tipo de relación, las revisiones de fuente y el registro de publicación de un hecho publicado por su factId; aquí no se puede crear, editar ni revocar ninguna declaración.", login: "Iniciar sesión o cambiar de cuenta", factId: "ID del hecho", lookup: "Consultar", busy: "Consultando…", empty: "Introduce el ID de un hecho publicado.", unavailable: "Consulta no disponible. Comprueba tu sesión y acceso e inténtalo de nuevo.", notFound: "No se encontró ese hecho, o no está publicado.", invalid: "Ese ID de hecho no es válido.", relation: "Relación", domainType: "Tipo de sujeto", rangeType: "Tipo de objeto", unregistered: "Esta relación no está registrada (no debería ocurrir; repórtalo).", subjectId: "Sujeto", objectId: "Objeto", predicate: "Predicado", sources: "Fuentes", sourceHistory: "Historial de revisiones de la fuente", auditTrail: "Registro de auditoría de publicación", sourceKey: "Identificador de fuente", revisionLabel: "Etiqueta de revisión", publisher: "Editor", uri: "URI del documento", locator: "Ubicación del fragmento", snippetHash: "SHA256 del fragmento", fetchedAt: "Obtenido/enviado el", effectiveAt: "Vigente desde", lineageStatus: "Estado de procedencia", legacy: "Histórico (procedencia no rastreada)", tracked: "Procedencia rastreada", unknownTime: "Desconocido", state: "Estado", published: "Publicado", revoked: "Revocado", publicationVersion: "Versión de publicación", action: "Acción", note: "Nota", createdAt: "Fecha" },
  ru: { heading: "Поиск происхождения знаний", language: "Язык", review: "Проверка материалов", boundary: "Рабочая область только для чтения. Просмотр типа отношения, версий источника и записи публикации по factId; здесь нельзя создать, изменить или отозвать утверждение.", login: "Войти или сменить аккаунт", factId: "ID факта", lookup: "Найти", busy: "Поиск…", empty: "Введите ID опубликованного факта.", unavailable: "Поиск недоступен. Проверьте вход и права доступа и повторите попытку.", notFound: "Факт не найден или не опубликован.", invalid: "Некорректный ID факта.", relation: "Отношение", domainType: "Тип субъекта", rangeType: "Тип объекта", unregistered: "Это отношение не зарегистрировано (не должно происходить; сообщите).", subjectId: "Субъект", objectId: "Объект", predicate: "Предикат", sources: "Источники", sourceHistory: "История версий источника", auditTrail: "Журнал аудита публикации", sourceKey: "Идентификатор источника", revisionLabel: "Метка версии", publisher: "Издатель", uri: "URI документа", locator: "Расположение фрагмента", snippetHash: "SHA256 фрагмента", fetchedAt: "Получено/отправлено", effectiveAt: "Действует с", lineageStatus: "Статус происхождения", legacy: "Устаревшее (происхождение не отслеживается)", tracked: "Происхождение отслеживается", unknownTime: "Неизвестно", state: "Статус", published: "Опубликовано", revoked: "Отозвано", publicationVersion: "Версия публикации", action: "Действие", note: "Заметка", createdAt: "Время" },
  ar: { heading: "بحث أصل المعرفة", language: "اللغة", review: "مراجعة المحتوى المرشح", boundary: "مساحة عمل للقراءة فقط. اعرض نوع العلاقة ومراجعات المصدر وسجل النشر لحقيقة منشورة عبر factId؛ لا يمكن هنا إنشاء أو تعديل أو سحب أي تصريح.", login: "تسجيل الدخول أو تبديل الحساب", factId: "معرّف الحقيقة", lookup: "بحث", busy: "جارٍ البحث…", empty: "أدخل معرّف حقيقة منشورة.", unavailable: "البحث غير متاح حاليًا. تحقق من تسجيل الدخول وصلاحية الوصول ثم أعد المحاولة.", notFound: "لم يتم العثور على هذه الحقيقة، أو أنها غير منشورة.", invalid: "معرّف الحقيقة هذا غير صالح.", relation: "العلاقة", domainType: "نوع الموضوع", rangeType: "نوع الكائن", unregistered: "هذه العلاقة غير مسجلة (لا ينبغي أن يحدث هذا؛ يرجى الإبلاغ).", subjectId: "الموضوع", objectId: "الكائن", predicate: "المسند", sources: "المصادر", sourceHistory: "سجل مراجعات المصدر", auditTrail: "سجل تدقيق النشر", sourceKey: "معرّف المصدر", revisionLabel: "وسم المراجعة", publisher: "الناشر", uri: "URI المستند", locator: "موضع المقتطف", snippetHash: "SHA256 للمقتطف", fetchedAt: "وقت الجلب/الإرسال", effectiveAt: "ساري المفعول من", lineageStatus: "حالة التتبع", legacy: "قديم (غير متتبَّع)", tracked: "متتبَّع", unknownTime: "غير معروف", state: "الحالة", published: "منشور", revoked: "مسحوب", publicationVersion: "إصدار النشر", action: "الإجراء", note: "ملاحظة", createdAt: "الوقت" },
} as const satisfies Record<Locale, Record<string, string>>;

export const knowledgeReaderCopy = {
 en:{heading:"Travel notes",language:"Language",boundary:"Reviewed information for your selected city and situation. Read the conditions in each note and check the source before taking action. This is not complete city coverage.",signIn:"Sign in",refresh:"Refresh",city:"City",scene:"Situation",cities:["Shanghai","Beijing","Guangzhou","Chongqing"],scenes:["Arrival","Airport transport","Payment","Phone and internet","Public transport","Taxis","Rail","Attractions","Accommodation","Emergency help"],loading:"Loading current information…",empty:"No eligible reviewed information is available for this selection.",unavailable:"Information is unavailable. Check your sign-in and try again.",reviewed:"Reviewed",sources:"Sources and context",conditions:"Applies when",exclusions:"Not covered"},
 zh:{heading:"旅途参考",language:"语言",boundary:"按所选城市和场景提供已审核信息。请阅读每条内容的适用条件，行动前核对来源；这里不代表完整城市覆盖。",signIn:"登录",refresh:"刷新",city:"城市",scene:"场景",cities:["上海","北京","广州","重庆"],scenes:["入境","机场交通","支付","手机与网络","公共交通","出租车","高铁","景点","住宿","紧急求助"],loading:"正在读取当前信息…",empty:"该城市和场景目前没有符合使用条件的已审核信息。",unavailable:"信息暂不可用，请检查登录状态后重试。",reviewed:"审核日期",sources:"来源与上下文",conditions:"适用条件",exclusions:"不包含"},
} as const;

export const knowledgeEditorCopy = {
 zh:{mode:"登记旅程陈述",boundary:"审核与发布是两个独立步骤；每次读取都会重新检查适用范围和时效。",object:"对象标识",predicate:"关系",conditions:"条件标识（每行一个）",exclusions:"排除项标识（每行一个）",cities:"适用城市",scene:"场景",publish:"发布供站内测试读取",revoke:"撤销发布",expires:"使用期限",basis:"使用依据",original:"原创事实摘要",licence:"明确许可",note:"核验与使用说明",revoked:"已撤销",preview:"查看旅途参考"},
 en:{mode:"Register a travel statement",boundary:"Review and publication are separate. Scope and expiry are checked on every read.",object:"Object identifier",predicate:"Relation",conditions:"Condition identifiers (one per line)",exclusions:"Exclusion identifiers (one per line)",cities:"Applicable cities",scene:"Situation",publish:"Publish for first-party test reading",revoke:"Revoke publication",expires:"Use until",basis:"Basis for use",original:"Original factual summary",licence:"Explicit licence",note:"Verification and use note",revoked:"Revoked",preview:"View travel notes"},
 es:{mode:"Registrar una afirmación de viaje",boundary:"La revisión y la publicación son independientes. El alcance y la caducidad se comprueban en cada lectura.",object:"Identificador del objeto",predicate:"Relación",conditions:"Identificadores de condiciones (uno por línea)",exclusions:"Identificadores de exclusiones (uno por línea)",cities:"Ciudades aplicables",scene:"Situación",publish:"Publicar para lectura de prueba interna",revoke:"Revocar publicación",expires:"Utilizar hasta",basis:"Base de uso",original:"Resumen factual original",licence:"Licencia explícita",note:"Nota de verificación y uso",revoked:"Revocado",preview:"Ver notas de viaje"},
 ru:{mode:"Добавить утверждение о поездке",boundary:"Проверка и публикация разделены. Область применения и срок проверяются при каждом чтении.",object:"Идентификатор объекта",predicate:"Отношение",conditions:"Идентификаторы условий (по одному в строке)",exclusions:"Идентификаторы исключений (по одному в строке)",cities:"Применимые города",scene:"Ситуация",publish:"Опубликовать для внутреннего тестового чтения",revoke:"Отозвать публикацию",expires:"Использовать до",basis:"Основание использования",original:"Оригинальное изложение фактов",licence:"Явная лицензия",note:"Примечание о проверке и использовании",revoked:"Отозвано",preview:"Открыть заметки о поездке"},
 ar:{mode:"تسجيل معلومة سفر",boundary:"المراجعة والنشر خطوتان مستقلتان. يتم التحقق من النطاق والصلاحية عند كل قراءة.",object:"معرّف الكائن",predicate:"العلاقة",conditions:"معرّفات الشروط (واحد في كل سطر)",exclusions:"معرّفات الاستثناءات (واحد في كل سطر)",cities:"المدن المعنية",scene:"الحالة",publish:"نشر للقراءة التجريبية الداخلية",revoke:"سحب النشر",expires:"الاستخدام حتى",basis:"أساس الاستخدام",original:"ملخص حقائق أصلي",licence:"ترخيص صريح",note:"ملاحظة التحقق والاستخدام",revoked:"تم السحب",preview:"عرض ملاحظات السفر"},
} as const satisfies Record<Locale, Record<string,string>>;
