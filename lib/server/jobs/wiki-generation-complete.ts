 ...
 */
export function completeWikiGenerationJob(rpc: Rpc, completion: Completion, outcome: WikiGenerationJobOutcome) {
  if (outcome.kind === "succeeded" && !isValidWikiGenerationDraftOutput(outcome.output)) throw new TypeError("INVALID_INPUT");
