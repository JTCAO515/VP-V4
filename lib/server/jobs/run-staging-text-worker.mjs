...
try{
 ...
 await append({schemaVersion:'vpj07-worker-run/1',configurationDigest,phase:'started',observedAt:new Date().toISOString()});
 ...
 await append({schemaVersion:'vpj07-worker-run/1',configurationDigest,phase:'returned',result,observedAt:new Date().toISOString()});
